...
public class AbstractTest {
    ...
    public TestTaskSix.Job createJob(String name, String employer, String location, String positionType, String coreCompetency) throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        return (TestTaskSix.Job) jobConstructor.newInstance(
                name,
    ...
    protected String getJobFieldString(TestTaskSix.Job job, String fieldName, Boolean substituteEmpty) throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
    ...
    public String getJobString (TestTaskSix.Job job) throws NoSuchMethodException, ClassNotFoundException, InvocationTargetException, IllegalAccessException {
    ...
    protected int getJobId(TestTaskSix.Job job) throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        Class jobClass = getClassByName("Job");
